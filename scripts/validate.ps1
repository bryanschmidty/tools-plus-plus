...
$RequiredPaths = @(
    ...
    "behavior_packs\ToolsPlusPlus_BP\items\raw_sapphire_chunk.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_chunk.json",
    ...
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_chunk_from_smelting.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_from_sapphire_chunk_stonecutting.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_shard_from_sapphire_stonecutting.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_block_from_sapphire_chunks.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_chunks_from_sapphire_block.json",
    ...
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\raw_sapphire_chunk.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_chunk.png",
...
$RequiredItemTextureShortnames = @(
    ...
    "toolsplusplus:raw_sapphire_chunk",
