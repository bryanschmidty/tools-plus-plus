...
$RequiredPaths = @(
    ...
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_shard.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_ore.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_block.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_pickaxe.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_sword.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_spear.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_axe.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_hoe.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_shovel.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_helmet.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_chestplate.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_leggings.json",
    "behavior_packs\ToolsPlusPlus_BP\items\sapphire_boots.json",
    "behavior_packs\ToolsPlusPlus_BP\items\deepslate_sapphire_ore.json",
    "behavior_packs\ToolsPlusPlus_BP\items\eagle_eye_rifle.json",
    "behavior_packs\ToolsPlusPlus_BP\items\rifle_ammo.json",
    ...
    "behavior_packs\ToolsPlusPlus_BP\blocks\sapphire_ore.json",
    "behavior_packs\ToolsPlusPlus_BP\blocks\deepslate_sapphire_ore.json",
    "behavior_packs\ToolsPlusPlus_BP\blocks\sapphire_block.json",
    ...
    "behavior_packs\ToolsPlusPlus_BP\loot_tables\blocks\sapphire_ore.json",
    "behavior_packs\ToolsPlusPlus_BP\loot_tables\blocks\deepslate_sapphire_ore.json",
    "behavior_packs\ToolsPlusPlus_BP\loot_tables\blocks\sapphire_block.json",
    ...
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_shard_from_sapphire_stonecutting.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_block_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphires_from_sapphire_block.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_pickaxe_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_sword_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_spear_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_axe_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_hoe_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_shovel_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_helmet_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_chestplate_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_leggings_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\sapphire_boots_from_sapphires.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\eagle_eye_rifle.json",
    "behavior_packs\ToolsPlusPlus_BP\recipes\rifle_ammo.json",
    ...
    "behavior_packs\ToolsPlusPlus_BP\features\sapphire_ore_feature.json",
    "behavior_packs\ToolsPlusPlus_BP\feature_rules\sapphire_ore_overworld.json",
    ...
    "resource_packs\ToolsPlusPlus_RP\sounds\sound_definitions.json",
    ...
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_shard.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_pickaxe.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_sword.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_spear.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_axe.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_hoe.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_shovel.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_helmet.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_chestplate.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_leggings.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\sapphire_boots.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\eagle_eye_rifle.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\items\rifle_ammo.png",
    ...
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\models\armor\sapphire_1.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\models\armor\sapphire_2.png",
    ...
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\blocks\sapphire_ore.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\blocks\deepslate_sapphire_ore.png",
    "resource_packs\ToolsPlusPlus_RP\textures\toolsplusplus\blocks\sapphire_block.png",
    "resource_packs\ToolsPlusPlus_RP\textures\entity\spear\ruby_spear.png",
    "resource_packs\ToolsPlusPlus_RP\textures\entity\spear\sapphire_spear.png",
    ...
    "resource_packs\ToolsPlusPlus_RP\attachables\sapphire_spear.json",
    "resource_packs\ToolsPlusPlus_RP\attachables\sapphire_helmet.json",
    "resource_packs\ToolsPlusPlus_RP\attachables\sapphire_chestplate.json",
    "resource_packs\ToolsPlusPlus_RP\attachables\sapphire_leggings.json",
    "resource_packs\ToolsPlusPlus_RP\attachables\sapphire_boots.json",
...
$RequiredItemTextureShortnames = @(
    ...
    "toolsplusplus:sapphire",
    "toolsplusplus:sapphire_shard",
    "toolsplusplus:sapphire_pickaxe",
    "toolsplusplus:sapphire_sword",
    "toolsplusplus:sapphire_spear",
    "toolsplusplus:sapphire_axe",
    "toolsplusplus:sapphire_hoe",
    "toolsplusplus:sapphire_shovel",
    "toolsplusplus:sapphire_helmet",
    "toolsplusplus:sapphire_chestplate",
    "toolsplusplus:sapphire_leggings",
    "toolsplusplus:sapphire_boots",
    "toolsplusplus:eagle_eye_rifle",
    "toolsplusplus:rifle_ammo"
)
...
function Test-TerrainTextureJson {
    ...
    if (-not $json.texture_data.toolsplusplus_sapphire_ore) {
        throw "terrain_texture.json must define toolsplusplus_sapphire_ore"
    }

    if (-not $json.texture_data.toolsplusplus_sapphire_block) {
        throw "terrain_texture.json must define toolsplusplus_sapphire_block"
    }

    if (-not $json.texture_data.toolsplusplus_deepslate_sapphire_ore) {
        throw "terrain_texture.json must define toolsplusplus_deepslate_sapphire_ore"
    }
}
